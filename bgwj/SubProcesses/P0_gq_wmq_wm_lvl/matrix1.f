...
C     
C     Process: g d > w- u WEIGHTED=3
C     *   Decay: w- > e- ve~ WEIGHTED=2
C     Process: g s > w- c WEIGHTED=3
C     *   Decay: w- > e- ve~ WEIGHTED=2
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      CALL FFV2_3(W(1,4),W(1,3),GC_405,MDL_MW,MDL_WW,W(1,5))
      CALL OXXXXX(P(0,5),ZERO,NHEL(5),+1*IC(5),W(1,4))
      CALL FFV1_2(W(1,2),W(1,1),GC_7,ZERO,ZERO,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,3),W(1,4),W(1,5),GC_405,AMP(1))
      CALL FFV1_1(W(1,4),W(1,1),GC_7,ZERO,ZERO,W(1,3))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,2),W(1,3),W(1,5),GC_405,AMP(2))
