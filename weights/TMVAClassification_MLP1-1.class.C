...
class ReadMLP1-1 : public IClassifierReader {

 public:

   // constructor
   ReadMLP1-1( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadMLP1-1" ),
        fNvars( 8 ),
        fIsNormalised( false )
   {      
...
inline void ReadMLP1-1::Initialize()
{
...
inline double ReadMLP1-1::GetMvaValue__( const std::vector<double>& inputValues ) const
{
...
double ReadMLP1-1::ActivationFnc(double x) const {
   // sigmoid
   return 1.0/(1.0+exp(-x));
}
double ReadMLP1-1::OutputActivationFnc(double x) const {
   // identity
   return x;
}
   
// Clean up
inline void ReadMLP1-1::Clear() 
{
   // clean up the arrays
   ...
   inline double ReadMLP1-1::GetMvaValue( const std::vector<double>& inputValues ) const
   {
...
inline void ReadMLP1-1::InitTransform_1()
{
...
//_______________________________________________________________________
inline void ReadMLP1-1::Transform_1( std::vector<double>& iv, int cls) const
{
...
//_______________________________________________________________________
inline void ReadMLP1-1::InitTransform()
{
   InitTransform_1();
}

//_______________________________________________________________________
inline void ReadMLP1-1::Transform( std::vector<double>& iv, int sigOrBgd ) const
{
